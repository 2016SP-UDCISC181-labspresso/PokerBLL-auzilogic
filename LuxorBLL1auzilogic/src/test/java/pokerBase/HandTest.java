...
public class HandTest {
	...
	public void TestStraightEval1() {
		...
		System.out.println("actuall ishands1 " + iActualIsHandStraight);
	...
	public void TestFlushEval() {
		...
		Hand h = new Hand();
		h = SetHand(Flush,h); 
		assertTrue(Hand.isHandFlush(h, hs));
		assertFalse(Hand.isHandRoyalFlush(h, hs)); 
		assertFalse(Hand.isStraight(Flush, new Card())); 
		...
		System.out.println("-------------" +iActualIsHandFlush);
		assertEquals(iActualIsHandFlush,iExpectedIsHandFlush);		 
		System.out.println("iActualIsHandFlush: " + iActualIsHandFlush);
		assertEquals(h.getHandScore().getHiHand(),eRank.ACE.getiRankNbr());			
	}	
	...
	@Test
	public void TestRoyalFlush1Joker() {
		...
		//assertEquals(bExpectedIsRoyalFlush,bActualIsRoyalFlush);		
		assertTrue(Hand.isHandFlush(RoyalFlush));
		//assertEquals(hs.getHiHand(),eRank.ACE.getiRankNbr());	
	}
